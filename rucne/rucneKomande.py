...
class recepcijaProzor(QMainWindow):
    ...
    def __init__(self,login,name):
        ...
        self.labelvreme    = QLabel("Vreme: "+QTime.currentTime().toString("hh:mm"))
        f = QFont( "Arial", 10, QFont.Bold);
        self.labelvreme .setFont(f);
        self.labelvreme .setFixedWidth(250)
        button3 =  QPushButton("Zakazati");
        button4 =  QPushButton("Poništi zakazano");
        srednjivreme.addWidget( self.labelvreme )
        ...
        self.timervreme = QTimer();
        QObject.connect(self.timervreme, SIGNAL("timeout()"),     self.constantUpdatevreme)
