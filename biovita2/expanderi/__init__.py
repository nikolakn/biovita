...
class Expanderi:
    def __init__(self):
        ...
        self.svi = []
        self.svi.append(self.pins1 )
        self.svi.append(self.pins2 )
        self.svi.append(self.pins3 )
        self.svi.append(self.pins4 )
        self.svi.append(self.pins5 )
        self.svi.append(self.pins6 )
        
        wiringpi.wiringPiSetup()
        wiringpi.mcp23s17Setup(65,1,0x20) # first pin,spi port,i2c address
        wiringpi.mcp23s17Setup(81,1,1)
        wiringpi.mcp23s17Setup(97,1,2)
        wiringpi.mcp23s17Setup(113,1,3)
